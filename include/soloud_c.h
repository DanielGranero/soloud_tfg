...
enum SOLOUD_ENUMS
{
	...
	LOWPASSSHELV_WET = 0,
	LOWPASSSHELV_FREQC = 1,
	LOWPASSSHELV_ORDER = 2,
	LOWPASSSHELV_GAIN = 3,
	HIGHPASSSHELV_WET = 0,
	HIGHPASSSHELV_FREQC = 1,
	HIGHPASSSHELV_ORDER = 2,
	HIGHPASSSHELV_GAIN = 3,
	LOWPASSBUTT_WET = 0,
	LOWPASSBUTT_FREQC = 1,
	LOWPASSBUTT_ORDER = 2,
	HIGHPASSBUTT_WET = 0,
	HIGHPASSBUTT_FREQC = 1,
	HIGHPASSBUTT_ORDER = 2,
	PEAKFILTER_WET = 0,
	PEAKFILTER_GAIN = 1,
	PEAKFILTER_FREQ= 2,
	PEAKFILTER_Q = 3,
...
typedef void * LowPassShelvFilter;
typedef void * HighPassShelvFilter;
typedef void * LowPassButtFilter;
typedef void * HighPassButtFilter;
typedef void * PeakFilter;
 ...
 * LowPassShelvFilter
 */
void LowPassShelvFilter_destroy(LowPassShelvFilter * aLowPassShelvFilter);
int LowPassShelvFilter_getParamCount(LowPassShelvFilter * aLowPassShelvFilter);
const char * LowPassShelvFilter_getParamName(LowPassShelvFilter * aLowPassShelvFilter, unsigned int aParamIndex);
unsigned int LowPassShelvFilter_getParamType(LowPassShelvFilter * aLowPassShelvFilter, unsigned int aParamIndex);
float LowPassShelvFilter_getParamMax(LowPassShelvFilter * aLowPassShelvFilter, unsigned int aParamIndex);
float LowPassShelvFilter_getParamMin(LowPassShelvFilter * aLowPassShelvFilter, unsigned int aParamIndex);
LowPassShelvFilter * LowPassShelvFilter_create();
int LowPassShelvFilter_setParams(LowPassShelvFilter * aLowPassShelvFilter, float aFrequency, int aOrder, float aGain);

/*
 * HighPassShelvFilter
 */
void HighPassShelvFilter_destroy(HighPassShelvFilter * aHighPassShelvFilter);
int HighPassShelvFilter_getParamCount(HighPassShelvFilter * aHighPassShelvFilter);
const char * HighPassShelvFilterr_getParamName(HighPassShelvFilter * aHighPassShelvFilter, unsigned int aParamIndex);
unsigned int HighPassShelvFilter_getParamType(HighPassShelvFilter * aHighPassShelvFilter, unsigned int aParamIndex);
float HighPassShelvFilter_getParamMax(HighPassShelvFilter * aHighPassShelvFilter, unsigned int aParamIndex);
float HighPassShelvFilter_getParamMin(HighPassShelvFilter * aHighPassShelvFilter, unsigned int aParamIndex);
HighPassShelvFilter * HighPassShelvFilter_create();
int HighPassShelvFilter_setParams(HighPassShelvFilter * aHighPassShelvFilter, float aFrequency, int aOrder, float aGain);

/*
 * LowPassButtFilter
 */
void LowPassButtFilter_destroy(LowPassButtFilter * aLowPassButtFilter);
int LowPassButtFilter_getParamCount(LowPassButtFilter * aLowPassButtFilter);
const char * LowPassButtFilter_getParamName(LowPassButtFilter * aLowPassButtFilter, unsigned int aParamIndex);
unsigned int LowPassButtFilter_getParamType(LowPassButtFilter * aLowPassButtFilter, unsigned int aParamIndex);
float LowPassButtFilter_getParamMax(LowPassButtFilter * aLowPassButtFilter, unsigned int aParamIndex);
float LowPassButtFilter_getParamMin(LowPassButtFilter * aLowPassButtFilter, unsigned int aParamIndex);
LowPassButtFilter * LowPassButtFilter_create();
int LowPassButtFilter_setParams(LowPassButtFilter * aLowPassButtFilter, float aFrequency, int aOrder, float aGain);

/*
 * HighPassButtFilter
 */
void HighPassButtFilter_destroy(HighPassButtFilter * aHighPassButtFilter);
int HighPassButtFilter_getParamCount(HighPassButtFilter * aHighPassButtFilter);
const char * HighPassButtFilterr_getParamName(HighPassButtFilter * aHighPassButtFilter, unsigned int aParamIndex);
unsigned int HighPassButtFilter_getParamType(HighPassButtFilter * aHighPassButtFilter, unsigned int aParamIndex);
float HighPassButtFilter_getParamMax(HighPassButtFilter * aHighPassButtFilter, unsigned int aParamIndex);
float HighPassButtFilter_getParamMin(HighPassButtFilter * aHighPassButtFilter, unsigned int aParamIndex);
HighPassButtFilter * HighPassButtFilter_create();
int HighPassButtFilter_setParams(HighPassButtFilter * aHighPassButtFilter, float aFrequency, int aOrder, float aGain);

/*
 * PeakFilter
 */
void PeakFilter_destroy(PeakFilter * aPeakFilter);
int PeakFilter_getParamCount(PeakFilter * aPeakFilter);
const char * PeakFilterr_getParamName(PeakFilter * aPeakFilter, unsigned int aParamIndex);
unsigned int PeakFilter_getParamType(PeakFilter * aPeakFilter, unsigned int aParamIndex);
float PeakFilter_getParamMax(PeakFilter * aPeakFilter, unsigned int aParamIndex);
float PeakFilter_getParamMin(PeakFilter * aPeakFilter, unsigned int aParamIndex);
PeakFilter * PeakFilter_create();
int PeakFilter_setParams(PeakFilter * aPeakFilter, float aFrequency, int aOrder, float aGain);
