#ifndef soloud_highpass_shelv_h
#define soloud_highpass_shelv_h
...
namespace SoLoud {
    ...
    class HighPassShelvInstance : public FilterInstance
    {
    ...
    public:
        ...
        HighPassShelvInstance(HighPassShelv* aParent);
        
        // Destructor de la instancia
        virtual ~HighPassShelvInstance();
    };

    class HighPassShelv : public Filter {
    public:
        ...
        virtual HighPassShelvInstance* createInstance();
