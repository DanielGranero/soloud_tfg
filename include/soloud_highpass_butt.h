#ifndef soloud_highpass_butt_h
#define soloud_highpass_butt_h
...
namespace SoLoud{
    ...
    class HighPassButtInstance : public FilterInstance
    {
    ...
    public:
        ...
        virtual ~HighPassButtInstance();

        // Constructor de la instancia
        HighPassButtInstance(HighPassButt * aParent);
    };
    
    class HighPassButt : public Filter{
    public:
        ...
        virtual HighPassButtInstance *createInstance();
