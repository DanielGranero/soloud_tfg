...
#include "../include/soloud_lowpass_shelv.h"
#include "../include/soloud_highpass_shelv.h"
#include "../include/soloud_lowpass_butt.h"
#include "../include/soloud_highpass_butt.h"
#include "../include/soloud_peakfilter.h"
...
void LowPassShelvFilter_destroy(void * aClassPtr)
{
  delete (LowPassShelv *)aClassPtr;
}

int LowPassShelvFilter_getParamCount(void * aClassPtr)
{
	LowPassShelv * cl = (LowPassShelv *)aClassPtr;
	return cl->getParamCount();
}

const char * LowPassShelvFilter_getParamName(void * aClassPtr, unsigned int aParamIndex)
{
	LowPassShelv * cl = (LowPassShelv *)aClassPtr;
	return cl->getParamName(aParamIndex);
}

unsigned int LowPassShelvFilter_getParamType(void * aClassPtr, unsigned int aParamIndex)
{
	LowPassShelv * cl = (LowPassShelv *)aClassPtr;
	return cl->getParamType(aParamIndex);
}

float LowPassShelvFilter_getParamMax(void * aClassPtr, unsigned int aParamIndex)
{
	LowPassShelv * cl = (LowPassShelv *)aClassPtr;
	return cl->getParamMax(aParamIndex);
}

float LowPassShelvFilter_getParamMin(void * aClassPtr, unsigned int aParamIndex)
{
	LowPassShelv * cl = (LowPassShelv *)aClassPtr;
	return cl->getParamMin(aParamIndex);
}

void * LowPassShelvFilter_create()
{
  return (void *)new LowPassShelv;
}

int LowPassShelvFilter_setParams(void * aClassPtr, float aFrequency, int aOrder, float aGain)
{
	LowPassShelv * cl = (LowPassShelv *)aClassPtr;
	return cl->setParams(aFrequency, aOrder, aGain);
}

// HIGH PASS SHELVING

void HighPassShelvFilter_destroy(void * aClassPtr)
{
  delete (HighPassShelv *)aClassPtr;
}

int HighPassShelvFilter_getParamCount(void * aClassPtr)
{
	HighPassShelv * cl = (HighPassShelv *)aClassPtr;
	return cl->getParamCount();
}

const char * HighPassShelvFilter_getParamName(void * aClassPtr, unsigned int aParamIndex)
{
	HighPassShelv * cl = (HighPassShelv *)aClassPtr;
	return cl->getParamName(aParamIndex);
}

unsigned int HighPassShelvFilter_getParamType(void * aClassPtr, unsigned int aParamIndex)
{
	HighPassShelv * cl = (HighPassShelv *)aClassPtr;
	return cl->getParamType(aParamIndex);
}

float HighPassShelvFilter_getParamMax(void * aClassPtr, unsigned int aParamIndex)
{
	HighPassShelv * cl = (HighPassShelv *)aClassPtr;
	return cl->getParamMax(aParamIndex);
}

float HighPassShelvFilter_getParamMin(void * aClassPtr, unsigned int aParamIndex)
{
	HighPassShelv * cl = (HighPassShelv *)aClassPtr;
	return cl->getParamMin(aParamIndex);
}

void * HighPassShelvFilter_create()
{
  return (void *)new HighPassShelv;
}

int HighPassShelvFilter_setParams(void * aClassPtr, float aFrequency, int aOrder, float aGain)
{
	HighPassShelv * cl = (HighPassShelv *)aClassPtr;
	return cl->setParams(aFrequency, aOrder, aGain);
}
...
void LowPassButtFilter_destroy(void * aClassPtr)
{
  delete (LowPassButt *)aClassPtr;
}

int LowPassButtFilter_getParamCount(void * aClassPtr)
{
	LowPassButt * cl = (LowPassButt *)aClassPtr;
	return cl->getParamCount();
}

const char * LowPassButtFilter_getParamName(void * aClassPtr, unsigned int aParamIndex)
{
	LowPassButt * cl = (LowPassButt *)aClassPtr;
	return cl->getParamName(aParamIndex);
}

unsigned int LowPassButtFilter_getParamType(void * aClassPtr, unsigned int aParamIndex)
{
	LowPassButt * cl = (LowPassButt *)aClassPtr;
	return cl->getParamType(aParamIndex);
}

float LowPassButtFilter_getParamMax(void * aClassPtr, unsigned int aParamIndex)
{
	LowPassButt * cl = (LowPassButt *)aClassPtr;
	return cl->getParamMax(aParamIndex);
}

float LowPassButtFilter_getParamMin(void * aClassPtr, unsigned int aParamIndex)
{
	LowPassButt * cl = (LowPassButt *)aClassPtr;
	return cl->getParamMin(aParamIndex);
}

void * LowPassButtFilter_create()
{
  return (void *)new LowPassButt;
}

int LowPassButtFilter_setParams(void * aClassPtr, float aFrequency, int aOrder, float aGain)
{
	LowPassButt * cl = (LowPassButt *)aClassPtr;
	return cl->setParams(aFrequency, aOrder);
}

// HIGH PASS BUTTERWORTH

void HighPassButtFilter_destroy(void * aClassPtr)
{
  delete (HighPassButt *)aClassPtr;
}

int HighPassButtFilter_getParamCount(void * aClassPtr)
{
	HighPassButt * cl = (HighPassButt *)aClassPtr;
	return cl->getParamCount();
}

const char * HighPassButtFilter_getParamName(void * aClassPtr, unsigned int aParamIndex)
{
	HighPassButt * cl = (HighPassButt *)aClassPtr;
	return cl->getParamName(aParamIndex);
}

unsigned int HighPassButtFilter_getParamType(void * aClassPtr, unsigned int aParamIndex)
{
	HighPassButt * cl = (HighPassButt *)aClassPtr;
	return cl->getParamType(aParamIndex);
}

float HighPassButtFilter_getParamMax(void * aClassPtr, unsigned int aParamIndex)
{
	HighPassButt * cl = (HighPassButt *)aClassPtr;
	return cl->getParamMax(aParamIndex);
}

float HighPassButtFilter_getParamMin(void * aClassPtr, unsigned int aParamIndex)
{
	HighPassButt * cl = (HighPassButt *)aClassPtr;
	return cl->getParamMin(aParamIndex);
}

void * HighPassButtFilter_create()
{
  return (void *)new HighPassButt;
}

int HighPassButtFilter_setParams(void * aClassPtr, float aFrequency, int aOrder, float aGain)
{
	HighPassButt * cl = (HighPassButt *)aClassPtr;
	return cl->setParams(aFrequency, aOrder);
}
...
void PeakFilter_destroy(void * aClassPtr)
{
  delete (PeakFilter *)aClassPtr;
}

int PeakFilter_getParamCount(void * aClassPtr)
{
	PeakFilter * cl = (PeakFilter *)aClassPtr;
	return cl->getParamCount();
}

const char * PeakFilter_getParamName(void * aClassPtr, unsigned int aParamIndex)
{
	PeakFilter * cl = (PeakFilter *)aClassPtr;
	return cl->getParamName(aParamIndex);
}

unsigned int PeakFilter_getParamType(void * aClassPtr, unsigned int aParamIndex)
{
	PeakFilter * cl = (PeakFilter *)aClassPtr;
	return cl->getParamType(aParamIndex);
}

float PeakFilter_getParamMax(void * aClassPtr, unsigned int aParamIndex)
{
	PeakFilter * cl = (PeakFilter *)aClassPtr;
	return cl->getParamMax(aParamIndex);
}

float PeakFilter_getParamMin(void * aClassPtr, unsigned int aParamIndex)
{
	PeakFilter * cl = (PeakFilter *)aClassPtr;
	return cl->getParamMin(aParamIndex);
}

void * PeakFilter_create()
{
  return (void *)new PeakFilter;
}

int PeakFilter_setParams(void * aClassPtr, float aFrequency, int aOrder, float aGain)
{
	PeakFilter * cl = (PeakFilter *)aClassPtr;
	return cl->setParams(aFrequency, aOrder, aGain);
}
